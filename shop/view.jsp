...
<div class="goods">
 <div class="goodsImg">
  <img src="display?fileName=${view.gdsImg}">
 </div>
...
<p class="cartStock">
 ...
 $(".addCart_btn").click(function(){
  ...
  $.ajax({
   url : "${pageContext.request.contextPath}/shop/view/addCart",
   type : "post",
   data : data,
...
<div id="reply">
 ...
 <c:if test="${member == null }">
  <p>소감을 남기시려면 <a href="${pageContext.request.contextPath}/member/signin">로그인</a>해주세요</p>
 </c:if>
...
$(".modal_modify_btn").click(function(){
	 ...
	 if(modifyConfirm) {
	  ...
	  $.ajax({
	   url : "${pageContext.request.contextPath}/shop/view/modifyReply",
	   type : "post",
	   data : data,
	   success : function(result){
