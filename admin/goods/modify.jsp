...
.select_img img{wodth:500px; margin: 20px 0;}
</style>
...
<div class="inputArea">
 ...
 <div class="select_img">
  <img src="display?fileName=${goods.gdsImg}" />
...
<script>
 $("#back_Btn").click(function(){
  //history.back();
  location.href = "${pageContext.request.contextPath}/admin/goods/view?n=" + ${goods.gdsNum};
 });   
</script>
</div>   
</form>
